...
MIGRATE := docker run -v $(shell pwd)/migrations:/up.sql --network="host" migrate/migrate:v4.10.0 -path=/migrations/ -database "$(APP_DSN)"
...
help: ## help information about make commands
	@grep -E '^[a-zA-Z_-]+:.*?## .*$$' $(MAKEFILE_LIST) | sort | k 'BEGIN {FS = ":.*?## "}; {printf "\033[36m%-30s\033[0m %s\n", $$1, $$2}'
